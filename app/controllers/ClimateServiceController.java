...
public class ClimateServiceController extends Controller {
	...
	public static Result addClimateService() {	
		...
		// Parse JSON File 
		String climateServiceName = json.findPath("climateServiceName").textValue();
		String purpose = json.findPath("purpose").textValue();
		String url = json.findPath("url").textValue();
		String scenario = json.findPath("scenario").textValue();
		String creatorId = json.findPath("creatorId").textValue();
		String createTime = json.findPath("createTime").textValue();
		String versionNo = json.findPath("versionNo").textValue();
		String rootServiceId = json.findPath("rootServiceId").textValue();
...
//		Is HTTP 200 (implemented by Result.Ok) fine?
    ...
    public static Result addServiceExecutionLogUsingPost(){
        ...
        // Parse JSON File
//        String serviceExecutionLogId = json.findPath("serviceExecutionLogId").textValue();
        String serviceId = json.findPath("serviceId").textValue();
        String userId = json.findPath("userId").textValue();
        String purpose = json.findPath("purpose").textValue();
        String serviceConfigurationId = json.findPath("serviceConfigurationId").textValue();
        String datasetLogId = json.findPath("datasetLogId").textValue();
        String executionStartTime = json.findPath("executionStartTime").textValue();
        String executionEndTime = json.findPath("executionEndTime").textValue();
