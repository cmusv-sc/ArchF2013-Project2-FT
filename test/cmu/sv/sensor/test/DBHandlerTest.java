...
public class DBHandlerTest {
	...
	public void testAddReadings(){
		assertEquals("The reading should be successfully added", dbHandler.addReading(1, 1, "Temperature", 450.0), true);
		assertEquals("The reading should not be added because of duplicate key", dbHandler.addReading(1, 1, "Temperature", 300.0), false);
		...
		assertEquals("The reading should be null for nonexist query", dbHandler.searchReading(1, 2), null);
