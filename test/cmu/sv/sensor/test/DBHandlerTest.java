...
public class DBHandlerTest {
	...
	public void testAddReadings(){
		assertEquals("The reading should be successfully added", dbHandler.addReading(new Long(1), new Long(1), "Temperature", 450.0), true);
		assertEquals("The reading should not be added because of duplicate key", dbHandler.addReading(new Long(1), new Long(1), "Temperature", 300.0), false);
		SensorReading reading = dbHandler.searchReading(new Long(1), new Long(1), "Temperature");
		...
		assertEquals("The reading should be null for nonexist query", dbHandler.searchReading(new Long(1), new Long(2), "Temperature"), null);
